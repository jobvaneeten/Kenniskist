...
export default maakLevel({
  ...
  kaart: [
    ...
    p(116) + 'd' + p(19),
    p(116) + 'd' + p(19),
    p(30) + munt(6) + p(30) + munt(6) + p(30) + munt(6) + p(8) + 'd' + p(19),
    p(28) + plat(10) + p(26) + plat(10) + p(26) + plat(10) + p(6) + 'd' + p(19),
    p(6) + munt(5) + p(25) + munt(5) + p(25) + munt(5) + p(25) + munt(5) + p(15) + 'd' + p(19),
