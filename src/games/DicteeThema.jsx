...
export default function DicteeThema({ onBack, addCuruntie, addBriefgeld }) {
    ...
    <>
      <div className="game-screen dictee-screen">
        ...
        <iframe
          ...
          src={`${import.meta.env.BASE_URL}taalactief5/dictee-thema8.html`}
          title="Taal Actief 5 — Dictee thema 8"
        />
      </div>
      {overlay}
    </>
